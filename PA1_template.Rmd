...
Proceed to alculate the ***MEAN*** and ***MEDIAN*** of the number of steps taken per day.
...
To fill up missing values, we can replace them with the mean value at the same interval across days. In most of the cases the median is a better centrality measure than mean, but in our case the total median is not much far away from total mean, and probably we can make the mean and median meets.
...
The nxt chunck of code checks whether there are any missing values remaining or not
